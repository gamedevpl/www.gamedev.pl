 ...
 * out, the control stays clickable and opens the sign-in modal: greying it out
  ...
  return (
    <>
      ...
      <AuthModal
        ...
        title={t('player.feedback.signInTitle')}
        subtitle={t('player.feedback.signInSubtitle')}
      />
    </>
  );
}
