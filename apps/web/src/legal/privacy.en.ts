    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          kind: 'p',
          text:
            'The default build permission returns game and round data only — not your email, account identifier, ' +
            'or other creators’ private account data. A separate ownership permission, if you grant it, also returns ' +
            'your current role, opaque member keys, and public profile names of current members; never recipient codes.',
        },
        {
          kind: 'p',
          text:
