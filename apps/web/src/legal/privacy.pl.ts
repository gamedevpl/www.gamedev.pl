    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          kind: 'p',
          text:
            'Domyślne uprawnienie budowy zwraca dane o grze i rundzie — nie e-mail, identyfikator konta ani ' +
            'prywatnych danych kont innych twórców. Osobne uprawnienie ownership, jeśli je przyznasz, zwraca też ' +
            'Twoją rolę, nieprzezroczyste klucze członków i publiczne nazwy profili; nigdy kodów odbiorcy.',
        },
        {
          kind: 'p',
          text:
          ...
          rows: [
            ...
            [
              ...
              'Generuje wstępny szkic Twojej gry; rysuje ilustracje do odpowiedzi na pytanie pomocnicze o wygląd ' +
                'gry; proponuje tytuł i pytania do opisu, gdy Gemini nie działa; pisze grę jako wybrany agent; ' +
                'zastępuje klasyfikator Gemini, gdy jest niedostępny, żeby moderacja nigdy nie ustała',
              'USA — standardowe klauzule umowne',
            ],
