...
function channelDelivery(brief: BuildBrief, creating: boolean): string[] {
  return [
    ...
    '- Every game must ship an EditorKit editor: prefer EDITOR.ts, or provide EDITOR.json, with at least three meaningful tunables or one content collection.',
    '- Keep EDITOR.json/EDITOR.ts, EDITOR.content.json when applicable, and game/editor-content.ts generated and in sync; stage them as part of the game source.',
