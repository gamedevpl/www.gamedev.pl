...
import { FirestoreNotificationsStore } from './slices/notifications.js';
...
export class FirestoreStore extends SubmissionFacade implements Store {
  ...
  protected shelfStore: FirestoreShelfStore;
  ...
  constructor(db?: Firestore) {
    ...
    this.shelfStore = new FirestoreShelfStore(this.db);
