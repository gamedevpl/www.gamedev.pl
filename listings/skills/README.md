...
screenshot early (or skip and read `get_gate_media` in a later/resumed run once a
preview verdict is already available after `mode=preview` when there is no
