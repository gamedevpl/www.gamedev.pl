...
| [`chatgpt-apps-connector/listing.md`](./chatgpt-apps-connector/listing.md)           | ChatGPT + Codex Plugin directory        | Draft — https://platform.openai.com/plugins (identity-verified Platform org). Now a plugin submission (skill + server), not a bare connector                                                                                                                                                                                   |
