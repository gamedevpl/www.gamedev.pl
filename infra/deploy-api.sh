...
# Version-checked, not described, for the 2026-08-21 reason given below.
if gcloud secrets versions access latest --secret=option-image-api-key --project "$PROJECT_ID" >/dev/null 2>&1; then
