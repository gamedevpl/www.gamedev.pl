...
| [`.claude/skills/ingest-desk-reviews/SKILL.md`](.claude/skills/ingest-desk-reviews/SKILL.md)               | When **exporting `/review` desk outcomes** and syncing them into games-repo `game-assessment` issues for catalog improvement agents. Companion skill lives in `www.gamedev.pl-games`.                                                     |
