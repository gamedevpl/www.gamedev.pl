...
`;function pi({worldState:e,setWorldState:t,updateWorldState:s}){return u.jsx(Me,{children:u.jsxs(Te,{children:[u.jsx(ui,{children:u.jsx(Fe,{state:e})}),u.jsx(Xe,{updateWorldTime:i=>s(e,i)}),u.jsx($e,{worldState:e,setWorldState:t}),u.jsx(Be,{worldState:e})]})})}const Jt="fullScreenMessage",Qt="fullScreenMessageAction";function P(e,t,s,i="",n,o,r){ft(Jt,{message:e,startTimestamp:t,endTimestamp:s,messageId:i,actions:n,prompt:o,fullScreen:r??!!(n!=null&&n.length)})}function te(e,t){ft(Qt,{messageId:e,actionId:t})}function ee(e){Ut(Jt,t=>{e(t)})}function mt(e){Ut(Qt,t=>{e(t)})}function mi({worldState:e,onGameOver:t}){const[s,i]=m.useState(null),[n,o]=m.useState(!1);return m.useEffect(()=>{var x;if(n)return;const r=Object.fromEntries(e.states.map(f=>[f.id,e.cities.filter(g=>g.stateId===f.id).reduce((g,b)=>g+b.populationHistogram[b.populationHistogram.length-1].population,0)])),c=Object.values(r).filter(f=>f>0).length,l=e.launchSites.length===0,h=e.timestamp,a=e.states.filter(f=>r[f.id]>0&&Object.entries(f.strategies).filter(([g,b])=>r[g]>0&&b===y.HOSTILE).length>0),p=e.launchSites.some(f=>f.lastLaunchTimestamp&&h-f.lastLaunchTimestamp<tt),d=tt-h;if(!a.length&&!p&&d>0&&d<=10&&(s?P(`Game will end in ${Math.ceil(d)} seconds if no action is taken!`,s,s+10,"gameOverCountdown",void 0,!1,!0):i(h)),c<=1||l||!a.length&&!p&&h>tt){const f=c===1?(x=e.states.find(g=>r[g.id]>0))==null?void 0:x.id:void 0;o(!0),P(["Game Over!","Results will be shown shortly..."],h,h+5,"gameOverCountdown",void 0,!1,!0),setTimeout(()=>{t({populations:Object.fromEntries(e.states.map(g=>[g.id,r[g.id]])),winner:f,stateNames:Object.fromEntries(e.states.map(g=>[g.id,g.name])),playerStateId:e.states.find(g=>g.isPlayerControlled).id})},5e3)}},[e,t,s,n]),null}const gi=({setGameState:e})=>{const{state:{result:t}}=Ot(),s=()=>{e(q,{stateName:t.stateNames[t.playerStateId]})};return u.jsxs("div",{children:[u.jsx("h2",{children:"Game Over"}),t.winner?u.jsxs("p",{children:["The winner is ",t.stateNames[t.winner]," with ",t.populations[t.winner]," population alive."]}):u.jsx("p",{children:"It's a draw!"}),u.jsx("button",{onClick:s,children:"Play Again"}),u.jsx("br",{}),u.jsx("br",{}),u.jsx("a",{href:"/games/nukes/",children:"Back to main menu"})]})},ct={Component:gi,path:"played"};function yi({worldState:e}){var h;const[t,s]=m.useState([]),[i,n]=m.useState(null);ee(a=>{s(p=>a.messageId&&p.find(d=>d.messageId===a.messageId)?[...p.map(d=>d.messageId===a.messageId?a:d)]:[a,...p])});const o=t.sort((a,p)=>a.actions&&!p.actions?-1:!a.actions&&p.actions?1:a.startTimestamp-p.startTimestamp);if(mt(a=>{s(p=>p.filter(d=>d.messageId!==a.messageId))}),m.useEffect(()=>{const a=o.find(p=>p.fullScreen&&p.startTimestamp<=e.timestamp&&p.endTimestamp>e.timestamp);n(a||null)},[o,e.timestamp]),!i)return null;const c=((a,p)=>p<a.startTimestamp?"pre":p<a.startTimestamp+.5?"pre-in":p>a.endTimestamp-.5?"post-in":p>a.endTimestamp?"post":"active")(i,e.timestamp),l=a=>Array.isArray(a)?a.map((p,d)=>u.jsx("div",{children:p},d)):a;return u.jsxs(bi,{"data-message-state":c,"data-action":(((h=i.actions)==null?void 0:h.length)??0)>0,children:[u.jsx(_i,{children:l(i.message)}),i.prompt&&i.actions&&u.jsx(Ei,{children:i.actions.map((a,p)=>u.jsx(Ti,{onClick:()=>te(i.messageId,a.id),children:a.text},p))})]})}const xi=jt`
  from {
    opacity: 0;
    transform: scale(0.9);
  }
...
`,bi=I.div`
  ...
  &[data-message-state='pre-in'] {
    display: flex;
    animation: ${xi} 0.5s ease-in-out forwards;
  }
  ...
  &[data-message-state='post-in'] {
    display: flex;
    animation: ${vi} 0.5s ease-in-out forwards;
  }
...
`,ki=({setGameState:e})=>{const{state:{stateName:t}}=Ot(),{worldState:s,setWorldState:i,updateWorldState:n}=_e(t);return u.jsxs(u.Fragment,{children:[u.jsx(pi,{worldState:s,updateWorldState:n,setWorldState:i}),u.jsx(yi,{worldState:s}),u.jsx(Mi,{}),u.jsx(mi,{worldState:s,onGameOver:o=>e(ct,{result:o})}),u.jsx(Ci,{worldState:s}),u.jsx(Si,{worldState:s,setWorldState:i})]})},q={Component:ki,path:"playing"},Oi=({setGameState:e})=>{const[t,s]=m.useState(Dt(1)[0]),i=()=>{e(q,{stateName:t})};return u.jsxs(u.Fragment,{children:[u.jsx("div",{children:u.jsx("input",{type:"text",placeholder:"Name your state",value:t,onChange:n=>s(n.currentTarget.value)})}),u.jsx("button",{onClick:i,disabled:!t,children:"Play"})]})},lt={Component:Oi,path:"play"},ji=I.div`
  height: 100vh;
  width: 100%;
