...
`,ar=C.div`
  ...
  pointer-events: none;
`;function sr({launchSite:e,worldTimestamp:t,isPlayerControlled:n}){const[a,s]=Hi(e),[i,r]=_e(),o=e.lastLaunchTimestamp&&e.lastLaunchTimestamp+fe>t,l=o?(t-e.lastLaunchTimestamp)/fe:0,c=e.modeChangeTimestamp&&t<e.modeChangeTimestamp+me,u=c?(t-e.modeChangeTimestamp)/me:0;return m.jsx(ir,{onMouseEnter:()=>i(e),onMouseLeave:()=>r(e),onClick:()=>n&&s(),style:{"--x":e.position.x,"--y":e.position.y,"--cooldown-progress":l,"--mode-change-progress":u},"data-selected":a,"data-cooldown":o,"data-mode":e.mode,"data-changing-mode":c,children:m.jsx(rr,{children:e.mode===k.ATTACK?"A":"D"})})}const ir=C.div`
...
`;function Po({worldState:e}){return m.jsx(zi,{children:m.jsx(Ni,{children:m.jsx(jo,{onGetViewportConfiguration:()=>$o(e),children:m.jsx(gr,{state:e})})})})}function $o(e){const t=e.states.find(g=>g.isPlayerControlled),n=window.innerWidth,a=window.innerHeight,s=t?e.sectors.filter(g=>g.stateId===t.id):e.sectors;let i=1/0,r=1/0,o=-1/0,l=-1/0;s.forEach(g=>{i=Math.min(i,g.rect.left),r=Math.min(r,g.rect.top),o=Math.max(o,g.rect.right),l=Math.max(l,g.rect.bottom)});const c=o-i+1,u=l-r+1,d=n/c,f=a/u,h=Math.min(d,f)*1,p=(i+o)/2,y=(r+l)/2;return e.sectors.forEach(g=>{i=Math.min(i,g.rect.left),r=Math.min(r,g.rect.top),o=Math.max(o,g.rect.right),l=Math.max(l,g.rect.bottom)}),{initialTranslate:{x:n/2-p*h,y:a/2-y*h},initialZoom:h,minX:i,minY:r,maxX:o,maxY:l}}const bn="fullScreenMessage",xn="fullScreenMessageAction";function j(e,t,n,a="",s,i,r){V(bn,{message:e,startTimestamp:t,endTimestamp:n,messageId:a,actions:s,prompt:i,fullScreen:r??!!(s!=null&&s.length)})}function Cn(e,t){V(xn,{messageId:e,actionId:t})}function Fn(e){ie(bn,t=>{e(t)})}function je(e){ie(xn,t=>{e(t)})}function No({worldState:e,onGameOver:t}){const[n,a]=b.useState(null),[s,i]=b.useState(!1);return b.useEffect(()=>{var h;if(s)return;const r=rn(e),o=Object.values(r).filter(p=>p>0).length,l=e.launchSites.length===0,c=e.timestamp,u=e.states.filter(p=>r[p.id]>0&&Object.entries(p.strategies).filter(([y,g])=>r[y]>0&&g===v.HOSTILE).length>0),d=e.launchSites.some(p=>p.lastLaunchTimestamp&&c-p.lastLaunchTimestamp<oe),f=oe-c;if(!u.length&&!d&&f>0&&f<=10&&(n?j(`Game will end in ${Math.ceil(f)} seconds if no action is taken!`,n,n+10,"gameOverCountdown",void 0,!1,!0):a(c)),o<=1||l||!u.length&&!d&&c>oe){const p=o===1?(h=e.states.find(y=>r[y.id]>0))==null?void 0:h.id:void 0;i(!0),j(["Game Over!","Results will be shown shortly..."],c,c+5,"gameOverCountdown",void 0,!1,!0),setTimeout(()=>{t({populations:r,winner:p,stateNames:Object.fromEntries(e.states.map(y=>[y.id,y.name])),playerStateId:e.states.find(y=>y.isPlayerControlled).id})},5e3)}},[e,t,n,s]),null}const Uo="/assets/player-lost-background-D2A_VJ6-.png",Yo="/assets/player-won-background-CkXgF24i.png",ht="/assets/draw-background-EwLQ9g28.png",zo=C.div`
  height: 100vh;
  width: 100%;
  display: flex;
  justify-content: center;
...
`,Ho=({setGameState:e})=>{const{state:{result:t}}=gt(),n=()=>{e(ae,{stateName:t.stateNames[t.playerStateId]})};let a,s;return t.winner?t.winner===t.playerStateId?(a=Yo,s=`Congratulations! ${t.stateNames[t.playerStateId]} has won with ${te(t.populations[t.playerStateId])} population alive.`):t.winner!==void 0?(a=Uo,s=`${t.stateNames[t.winner]} has won with ${te(t.populations[t.winner])} population alive. Your state has fallen.`):(a=ht,s="The game has ended in an unexpected state."):(a=ht,s="It's a draw! The world is partially destroyed, but there's still hope."),m.jsx(zo,{backgroundImage:a,children:m.jsxs("div",{children:[m.jsx("h2",{children:"Game Over"}),m.jsx("p",{children:s}),m.jsx("button",{onClick:n,children:"Play Again"}),m.jsx("br",{}),m.jsx("a",{href:"/games/nukes/",children:"Back to main menu"})]})})},Ae={Component:Ho,path:"played"};function Go({worldState:e}){var c;const[t,n]=b.useState([]),[a,s]=b.useState(null);Fn(u=>{n(d=>u.messageId&&d.find(f=>f.messageId===u.messageId)?[...d.map(f=>f.messageId===u.messageId?u:f)]:[u,...d])});const i=t.sort((u,d)=>u.actions&&!d.actions?-1:!u.actions&&d.actions?1:u.startTimestamp-d.startTimestamp);if(je(u=>{n(d=>d.filter(f=>f.messageId!==u.messageId))}),b.useEffect(()=>{const u=i.find(d=>d.fullScreen&&d.startTimestamp<=e.timestamp&&d.endTimestamp>e.timestamp);s(u||null)},[i,e.timestamp]),!a)return null;const o=((u,d)=>d<u.startTimestamp?"pre":d<u.startTimestamp+.5?"pre-in":d>u.endTimestamp-.5?"post-in":d>u.endTimestamp?"post":"active")(a,e.timestamp),l=u=>Array.isArray(u)?u.map((d,f)=>m.jsx("div",{children:d},f)):u;return m.jsxs(Xo,{"data-message-state":o,"data-action":(((c=a.actions)==null?void 0:c.length)??0)>0,children:[m.jsx(qo,{children:l(a.message)}),a.prompt&&a.actions&&m.jsx(Ko,{children:a.actions.map((u,d)=>m.jsx(Zo,{onClick:()=>Cn(a.messageId,u.id),children:u.text},d))})]})}const Vo=se`
  from {
    opacity: 0;
...
`,An="ALLIANCEPROPOSAL";function Jo(e,t,n,a=!1){const s=`${An}_${e.id}_${t.id}`,i=a?`${e.name} has become friendly towards you. Do you want to form an alliance?`:`${e.name} proposes an alliance with ${t.name}. Do you accept?`,r=n.timestamp,o=r+10;j(i,r,o,s,[{id:"accept",text:"Accept"},{id:"reject",text:"Reject"}],!0)}function Qo({worldState:e,setWorldState:t}){return je(n=>{if(n.messageId.startsWith(An)){const[,a,s]=n.messageId.split("_"),i=e.states.find(o=>o.id===a),r=e.states.find(o=>o.id===s);if(!i||!(r!=null&&r.isPlayerControlled))return;if(n.actionId==="accept"){const o=e.states.map(l=>l.id===a||l.id===s?{...l,strategies:{...l.strategies,[a]:v.FRIENDLY,[s]:v.FRIENDLY}}:l);t({...e,states:o}),j(`Alliance formed between ${i.name} and ${r.name}!`,e.timestamp,e.timestamp+5)}else n.actionId==="reject"&&j(`${r.name} has rejected the alliance proposal from ${i.name}.`,e.timestamp,e.timestamp+5)}}),null}function el({worldState:e}){const t=e.states.find(h=>h.isPlayerControlled),[n,a]=b.useState(!1),[s,i]=b.useState({}),[r,o]=b.useState([]),[l,c]=b.useState([]),[u,d]=b.useState(!1),f=Math.round(e.timestamp*10)/10;return b.useEffect(()=>{!n&&e.timestamp>0&&(a(!0),j("The game has started!",e.timestamp,e.timestamp+3))},[f]),b.useEffect(()=>{var h,p,y,g;if(t){const x=Object.fromEntries(e.states.map(E=>[E.id,E.strategies]));for(const E of e.states)for(const F of e.states.filter(R=>R.id!==E.id))t&&F.id===t.id&&E.strategies[F.id]===v.FRIENDLY&&F.strategies[E.id]!==v.FRIENDLY&&((h=s[E.id])==null?void 0:h[F.id])!==v.FRIENDLY&&Jo(E,t,e,!0),F.strategies[E.id]===v.FRIENDLY&&E.strategies[F.id]===v.FRIENDLY&&(((p=s[F.id])==null?void 0:p[E.id])!==v.FRIENDLY||((y=s[E.id])==null?void 0:y[F.id])!==v.FRIENDLY)&&j(`${F.name} has formed alliance with ${E.isPlayerControlled?"you":E.name}!`,f,f+3),E.strategies[F.id]===v.HOSTILE&&((g=s[E.id])==null?void 0:g[F.id])!==v.HOSTILE&&j(F.isPlayerControlled?`${E.name} has declared war on You!`:`${E.isPlayerControlled?"You have":E.name} declared war on ${F.name}!`,f,f+3,void 0,void 0,void 0,E.isPlayerControlled||F.isPlayerControlled);i(x)}},[f]),b.useEffect(()=>{t&&e.cities.forEach(h=>{const p=r.find(E=>E.id===h.id);if(!p)return;const y=h.population||0,g=p.population,x=Math.floor(g-y);x>0&&(h.stateId===t.id&&j(y===0?`Your city ${h.name} has been destroyed!`:[`Your city ${h.name} has been hit!`,`${x} casualties reported.`],f,f+3,void 0,void 0,!1,!0),V("cityDamage"))}),o(e.cities.map(h=>({...h})))},[f]),b.useEffect(()=>{if(t){const h=e.launchSites.filter(p=>p.stateId===t.id);l.length>0&&l.filter(y=>!h.some(g=>g.id===y.id)).forEach(()=>{j("One of your launch sites has been destroyed!",f,f+3,void 0,void 0,!1,!0)}),c(h)}},[f]),b.useEffect(()=>{if(t&&!u){const h=e.cities.filter(g=>g.stateId===t.id),p=e.launchSites.filter(g=>g.stateId===t.id);!h.some(g=>g.population>0)&&p.length===0&&(j(["You have been defeated.","All your cities are destroyed.","You have no remaining launch sites."],f,f+5,void 0,void 0,!1,!0),d(!0))}},[f]),null}function tl({worldState:e}){const[t,n]=b.useState([]);Fn(r=>{n(o=>r.messageId&&o.find(l=>l.messageId===r.messageId)?[...o.map(l=>l.messageId===r.messageId?r:l)]:[r,...o])}),je(r=>{n(o=>o.filter(l=>l.messageId!==r.messageId))});const a=r=>Array.isArray(r)?r.map((o,l)=>m.jsx("div",{children:o},l)):r,s=(r,o)=>{const u=o-r;return u>60?0:u>50?1-(u-50)/10:1},i=b.useMemo(()=>{const r=e.timestamp,o=60;return t.filter(l=>{const c=l.startTimestamp||0;return r-c<=o}).map(l=>({...l,opacity:s(l.startTimestamp||0,r)}))},[t,e.timestamp]);return m.jsx(nl,{children:i.map((r,o)=>m.jsxs(al,{style:{opacity:r.opacity},children:[m.jsx("div",{children:a(r.message)}),r.prompt&&r.actions&&m.jsx(sl,{children:r.actions.map((l,c)=>m.jsx(il,{onClick:()=>Cn(r.messageId,l.id),children:l.text},c))})]},o))})}const nl=C.div`
  position: fixed;
  right: 0;
  max-height: 300px;
  top: 10px;
...
`,ul=C.div`
  ...
  font-weight: bold;
  margin-right: 15px;
`;function cl({worldState:e}){const t=e.states.find(o=>o.isPlayerControlled);if(!t)return null;const n=(o,l,c=!1)=>{t.strategies[o.id]=l,c&&(o.strategies[t.id]=l)},a=o=>{if(o.id===t.id)return"#4CAF50";const l=t.strategies[o.id],c=o.strategies[t.id];return l===v.FRIENDLY&&c===v.FRIENDLY?"#4CAF50":l===v.HOSTILE||c===v.HOSTILE?"#F44336":"#9E9E9E"},s=rn(e),i=o=>{const l=e.cities.filter(h=>h.stateId===o),c=e.launchSites.filter(h=>h.stateId===o);if(l.length===0&&c.length===0){console.warn("No position information available for this state");return}const u=[...l.map(h=>h.position),...c.map(h=>h.position)],d=u.reduce((h,p)=>({x:h.x+p.x,y:h.y+p.y}),{x:0,y:0}),f={x:d.x/u.length,y:d.y/u.length};Bo(f)},r=o=>{const l=t.strategies[o.id],c=o.strategies[t.id];return m.jsxs(vl,{children:[(l===v.NEUTRAL&&c!==v.HOSTILE||l===v.FRIENDLY&&c!==v.FRIENDLY)&&m.jsx(Z,{color:"#4CAF50",onClick:u=>{u.stopPropagation(),n(o,v.FRIENDLY)},disabled:l===v.FRIENDLY&&c!==v.FRIENDLY,children:"Alliance"}),(l===v.HOSTILE||c===v.HOSTILE)&&m.jsx(Z,{color:"#9E9E9E",onClick:u=>{u.stopPropagation(),n(o,v.NEUTRAL)},disabled:l===v.NEUTRAL&&c!==v.NEUTRAL,children:"Peace"}),l===v.FRIENDLY&&c===v.FRIENDLY&&m.jsx(Z,{color:"#9E9E9E",onClick:u=>{u.stopPropagation(),n(o,v.NEUTRAL,!0)},children:"Neutral"}),l===v.NEUTRAL&&c!==v.HOSTILE&&m.jsx(Z,{color:"#F44336",onClick:u=>{u.stopPropagation(),n(o,v.HOSTILE,!0)},children:"Attack"})]})};return m.jsx(dl,{children:e.states.map(o=>m.jsxs(ml,{relationshipColor:a(o),onClick:()=>i(o.id),children:[m.jsx(fl,{style:{color:o.color},children:o.name.charAt(0)}),m.jsxs(hl,{children:[m.jsx(pl,{children:o.name}),m.jsxs(gl,{children:["👤 ",te(s[o.id])]}),o.id!==t.id?r(o):m.jsx(yl,{children:"This is you"})]})]},o.id))})}const dl=C.div`
  position: fixed;
  left: 0;
  bottom: 0;
  z-index: 1;
