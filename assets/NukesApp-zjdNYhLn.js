...
`,Ao=x.span`
  font-size: 0.9em;
  margin-bottom: 5px;
`;function Do({worldState:e,setWorldState:t}){return h.jsx(Di,{children:h.jsxs(xi,{children:[h.jsx(po,{onGetViewportConfiguration:()=>To(e),children:h.jsx(Zi,{state:e})}),h.jsx(gn,{worldState:e,setWorldState:t})]})})}function To(e){const t=e.states.find(g=>g.isPlayerControlled),n=window.innerWidth,a=window.innerHeight,s=t?e.sectors.filter(g=>g.stateId===t.id):e.sectors;let o=1/0,r=1/0,i=-1/0,l=-1/0;s.forEach(g=>{o=Math.min(o,g.rect.left),r=Math.min(r,g.rect.top),i=Math.max(i,g.rect.right),l=Math.max(l,g.rect.bottom)});const c=i-o+1,u=l-r+1,f=n/c,m=a/u,d=Math.min(f,m)*1,p=(o+i)/2,y=(r+l)/2;return e.sectors.forEach(g=>{o=Math.min(o,g.rect.left),r=Math.min(r,g.rect.top),i=Math.max(i,g.rect.right),l=Math.max(l,g.rect.bottom)}),{initialTranslate:{x:n/2-p*d,y:a/2-y*d},initialZoom:d,minX:o,minY:r,maxX:i,maxY:l}}const vn="fullScreenMessage",yn="fullScreenMessageAction";function w(e,t,n,a="",s,o,r){H(vn,{message:e,startTimestamp:t,endTimestamp:n,messageId:a,actions:s,prompt:o,fullScreen:r??!!(s!=null&&s.length)})}function bn(e,t){H(yn,{messageId:e,actionId:t})}function En(e){ne(vn,t=>{e(t)})}function Me(e){ne(yn,t=>{e(t)})}function Io({worldState:e,onGameOver:t}){const[n,a]=b.useState(null),[s,o]=b.useState(!1);return b.useEffect(()=>{var d;if(s)return;const r=pn(e),i=Object.values(r).filter(p=>p>0).length,l=e.launchSites.length===0,c=e.timestamp,u=e.states.filter(p=>r[p.id]>0&&Object.entries(p.strategies).filter(([y,g])=>r[y]>0&&g===E.HOSTILE).length>0),f=e.launchSites.some(p=>p.lastLaunchTimestamp&&c-p.lastLaunchTimestamp<se),m=se-c;if(!u.length&&!f&&m>0&&m<=10&&(n?w(`Game will end in ${Math.ceil(m)} seconds if no action is taken!`,n,n+10,"gameOverCountdown",void 0,!1,!0):a(c)),i<=1||l||!u.length&&!f&&c>se){const p=i===1?(d=e.states.find(y=>r[y.id]>0))==null?void 0:d.id:void 0;o(!0),w(["Game Over!","Results will be shown shortly..."],c,c+5,"gameOverCountdown",void 0,!1,!0),setTimeout(()=>{t({populations:r,winner:p,stateNames:Object.fromEntries(e.states.map(y=>[y.id,y.name])),playerStateId:e.states.find(y=>y.isPlayerControlled).id})},5e3)}},[e,t,n,s]),null}const So="/assets/player-lost-background-D2A_VJ6-.png",ko="/assets/player-won-background-CkXgF24i.png",ct="/assets/draw-background-EwLQ9g28.png",_o=x.div`
  height: 100vh;
  width: 100%;
  display: flex;
  justify-content: center;
...
`,Mo=({setGameState:e})=>{const{state:{result:t}}=dt(),n=()=>{e(ee,{stateName:t.stateNames[t.playerStateId]})};let a,s;return t.winner?t.winner===t.playerStateId?(a=ko,s=`Congratulations! ${t.stateNames[t.playerStateId]} has won with ${t.populations[t.playerStateId]<<0} population alive.`):t.winner!==void 0?(a=So,s=`${t.stateNames[t.winner]} has won with ${t.populations[t.winner]<<0} population alive. Your state has fallen.`):(a=ct,s="The game has ended in an unexpected state."):(a=ct,s="It's a draw! The world is partially destroyed, but there's still hope."),h.jsx(_o,{backgroundImage:a,children:h.jsxs("div",{children:[h.jsx("h2",{children:"Game Over"}),h.jsx("p",{children:s}),h.jsx("button",{onClick:n,children:"Play Again"}),h.jsx("br",{}),h.jsx("a",{href:"/games/nukes/",children:"Back to main menu"})]})})},Ce={Component:Mo,path:"played"};function Bo({worldState:e}){var c;const[t,n]=b.useState([]),[a,s]=b.useState(null);En(u=>{n(f=>u.messageId&&f.find(m=>m.messageId===u.messageId)?[...f.map(m=>m.messageId===u.messageId?u:m)]:[u,...f])});const o=t.sort((u,f)=>u.actions&&!f.actions?-1:!u.actions&&f.actions?1:u.startTimestamp-f.startTimestamp);if(Me(u=>{n(f=>f.filter(m=>m.messageId!==u.messageId))}),b.useEffect(()=>{const u=o.find(f=>f.fullScreen&&f.startTimestamp<=e.timestamp&&f.endTimestamp>e.timestamp);s(u||null)},[o,e.timestamp]),!a)return null;const i=((u,f)=>f<u.startTimestamp?"pre":f<u.startTimestamp+.5?"pre-in":f>u.endTimestamp-.5?"post-in":f>u.endTimestamp?"post":"active")(a,e.timestamp),l=u=>Array.isArray(u)?u.map((f,m)=>h.jsx("div",{children:f},m)):u;return h.jsxs(Oo,{"data-message-state":i,"data-action":(((c=a.actions)==null?void 0:c.length)??0)>0,children:[h.jsx(Lo,{children:l(a.message)}),a.prompt&&a.actions&&h.jsx(Po,{children:a.actions.map((u,f)=>h.jsx(Ro,{onClick:()=>bn(a.messageId,u.id),children:u.text},f))})]})}const wo=te`
  from {
    opacity: 0;
...
`,Cn="ALLIANCEPROPOSAL";function $o(e,t,n,a=!1){const s=`${Cn}_${e.id}_${t.id}`,o=a?`${e.name} has become friendly towards you. Do you want to form an alliance?`:`${e.name} proposes an alliance with ${t.name}. Do you accept?`,r=n.timestamp,i=r+10;w(o,r,i,s,[{id:"accept",text:"Accept"},{id:"reject",text:"Reject"}],!0)}function No({worldState:e,setWorldState:t}){return Me(n=>{if(n.messageId.startsWith(Cn)){const[,a,s]=n.messageId.split("_"),o=e.states.find(i=>i.id===a),r=e.states.find(i=>i.id===s);if(!o||!(r!=null&&r.isPlayerControlled))return;if(n.actionId==="accept"){const i=e.states.map(l=>l.id===a||l.id===s?{...l,strategies:{...l.strategies,[a]:E.FRIENDLY,[s]:E.FRIENDLY}}:l);t({...e,states:i}),w(`Alliance formed between ${o.name} and ${r.name}!`,e.timestamp,e.timestamp+5)}else n.actionId==="reject"&&w(`${r.name} has rejected the alliance proposal from ${o.name}.`,e.timestamp,e.timestamp+5)}}),null}function zo({worldState:e}){const t=e.states.find(d=>d.isPlayerControlled),[n,a]=b.useState(!1),[s,o]=b.useState({}),[r,i]=b.useState([]),[l,c]=b.useState([]),[u,f]=b.useState(!1),m=Math.round(e.timestamp*10)/10;return b.useEffect(()=>{!n&&e.timestamp>0&&(a(!0),w("The game has started!",e.timestamp,e.timestamp+3))},[m]),b.useEffect(()=>{var d,p,y,g;if(t){const C=Object.fromEntries(e.states.map(v=>[v.id,v.strategies]));for(const v of e.states)for(const F of e.states.filter(O=>O.id!==v.id))t&&F.id===t.id&&v.strategies[F.id]===E.FRIENDLY&&F.strategies[v.id]!==E.FRIENDLY&&((d=s[v.id])==null?void 0:d[F.id])!==E.FRIENDLY&&$o(v,t,e,!0),F.strategies[v.id]===E.FRIENDLY&&v.strategies[F.id]===E.FRIENDLY&&(((p=s[F.id])==null?void 0:p[v.id])!==E.FRIENDLY||((y=s[v.id])==null?void 0:y[F.id])!==E.FRIENDLY)&&w(`${F.name} has formed alliance with ${v.isPlayerControlled?"you":v.name}!`,m,m+3),v.strategies[F.id]===E.HOSTILE&&((g=s[v.id])==null?void 0:g[F.id])!==E.HOSTILE&&w(F.isPlayerControlled?`${v.name} has declared war on You!`:`${v.isPlayerControlled?"You have":v.name} declared war on ${F.name}!`,m,m+3,void 0,void 0,void 0,v.isPlayerControlled||F.isPlayerControlled);o(C)}},[m]),b.useEffect(()=>{t&&e.cities.forEach(d=>{const p=r.find(v=>v.id===d.id);if(!p)return;const y=d.population||0,g=p.population,C=Math.floor(g-y);C>0&&(d.stateId===t.id&&w(y===0?`Your city ${d.name} has been destroyed!`:[`Your city ${d.name} has been hit!`,`${C} casualties reported.`],m,m+3,void 0,void 0,!1,!0),H("cityDamage"))}),i(e.cities.map(d=>({...d})))},[m]),b.useEffect(()=>{if(t){const d=e.launchSites.filter(p=>p.stateId===t.id);l.length>0&&l.filter(y=>!d.some(g=>g.id===y.id)).forEach(()=>{w("One of your launch sites has been destroyed!",m,m+3,void 0,void 0,!1,!0)}),c(d)}},[m]),b.useEffect(()=>{if(t&&!u){const d=e.cities.filter(g=>g.stateId===t.id),p=e.launchSites.filter(g=>g.stateId===t.id);!d.some(g=>g.population>0)&&p.length===0&&(w(["You have been defeated.","All your cities are destroyed.","You have no remaining launch sites."],m,m+5,void 0,void 0,!1,!0),f(!0))}},[m]),null}function Go({worldState:e}){const[t,n]=b.useState([]);En(r=>{n(i=>r.messageId&&i.find(l=>l.messageId===r.messageId)?[...i.map(l=>l.messageId===r.messageId?r:l)]:[r,...i])}),Me(r=>{n(i=>i.filter(l=>l.messageId!==r.messageId))});const a=r=>Array.isArray(r)?r.map((i,l)=>h.jsx("div",{children:i},l)):r,s=(r,i)=>{const u=i-r;return u>60?0:u>50?1-(u-50)/10:1},o=b.useMemo(()=>{const r=e.timestamp,i=60;return t.filter(l=>{const c=l.startTimestamp||0;return r-c<=i}).map(l=>({...l,opacity:s(l.startTimestamp||0,r)}))},[t,e.timestamp]);return h.jsx(Yo,{children:o.map((r,i)=>h.jsxs(Uo,{style:{opacity:r.opacity},children:[h.jsx("div",{children:a(r.message)}),r.prompt&&r.actions&&h.jsx(Ho,{children:r.actions.map((l,c)=>h.jsx(Vo,{onClick:()=>bn(r.messageId,l.id),children:l.text},c))})]},i))})}const Yo=x.div`
  position: fixed;
  right: 0;
  max-height: 100%;
  bottom: 0;
...
`,ll=x.img`
  ...
  height: auto;
  image-rendering: pixelated;
`,ul=({setGameState:e})=>{const[t,n]=b.useState(!0);return b.useEffect(()=>{const a=setTimeout(()=>{n(!1)},5e3);return()=>clearTimeout(a)},[]),h.jsxs(il,{children:[h.jsx(rl,{isFlashing:t}),!t&&h.jsxs(ol,{children:[h.jsx(ll,{src:nl,alt:"Nukes game"}),h.jsx("button",{onClick:()=>e(xe),children:"Play"})]})]})},mt={Component:ul,path:""},cl=In`
:root {
