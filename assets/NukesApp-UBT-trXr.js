...
`,Dr=E.div`
  ...
  pointer-events: none;
`;function kr({launchSite:t,worldTimestamp:e,isPlayerControlled:n}){const[a,s]=hr(t),[r,i]=Ce(),o=t.lastLaunchTimestamp&&t.lastLaunchTimestamp+de>e,l=o?(e-t.lastLaunchTimestamp)/de:0;return f.jsx(Sr,{onMouseEnter:()=>r(t),onMouseLeave:()=>i(t),onClick:()=>n&&s(),style:{"--x":t.position.x,"--y":t.position.y,"--cooldown-progress":l},"data-selected":a,"data-cooldown":o})}const Sr=E.div`
  transform: translate(calc(var(--x) * 1px), calc(var(--y) * 1px)) translate(-50%, -50%);
  position: absolute;
  width: 5px;
  height: 10px;
...
`;function cn(t){return Object.fromEntries(t.states.map(e=>[e.id,e.population]))}function mn({worldState:t,setWorldState:e}){const n=t.states.find(o=>o.isPlayerControlled);if(!n)return null;const a=(o,l)=>{const c=t.states.map(u=>u.id===n.id?{...u,strategies:{...u.strategies,[o]:l}}:u);e({...t,states:c})},s=o=>{if(o===n.id)return"#4CAF50";switch(n.strategies[o]){case y.FRIENDLY:return"#4CAF50";case y.NEUTRAL:return"#FFC107";case y.HOSTILE:return"#F44336";default:return"#9E9E9E"}},r=cn(t),i=o=>{const l=t.cities.filter(p=>p.stateId===o),c=t.launchSites.filter(p=>p.stateId===o);if(l.length===0&&c.length===0){console.warn("No position information available for this state");return}const u=[...l.map(p=>p.position),...c.map(p=>p.position)],d=u.reduce((p,h)=>({x:p.x+h.x,y:p.y+h.y}),{x:0,y:0}),m={x:d.x/u.length,y:d.y/u.length};qi(m)};return f.jsx(eo,{children:t.states.map(o=>{var l;return f.jsxs(to,{relationshipColor:s(o.id),onClick:()=>i(o.id),children:[f.jsx(no,{children:o.name.charAt(0)}),f.jsxs(ao,{children:[f.jsx(so,{children:o.name}),f.jsx(ro,{children:((l=r[o.id])==null?void 0:l.toLocaleString())??"N/A"}),o.id!==n.id?f.jsx("select",{value:n.strategies[o.id],onClick:c=>c.stopPropagation(),onChange:c=>a(o.id,c.target.value),children:Object.values(y).map(c=>f.jsx("option",{value:c,children:c},c))}):"This is you"]})]},o.id)})})}const eo=E.div`
  position: fixed;
  left: 0;
  bottom: 0;
  z-index: 1;
...
`,ro=E.span`
  font-size: 0.9em;
  margin-bottom: 5px;
`;function io({worldState:t,setWorldState:e}){return f.jsx(fr,{children:f.jsxs(cr,{children:[f.jsx(Ki,{children:f.jsx(Mr,{state:t})}),f.jsx(mn,{worldState:t,setWorldState:e})]})})}const dn="fullScreenMessage",fn="fullScreenMessageAction";function M(t,e,n,a="",s,r,i){J(dn,{message:t,startTimestamp:e,endTimestamp:n,messageId:a,actions:s,prompt:r,fullScreen:i??!!(s!=null&&s.length)})}function hn(t,e){J(fn,{messageId:t,actionId:e})}function pn(t){De(dn,e=>{t(e)})}function Se(t){De(fn,e=>{t(e)})}function oo({worldState:t,onGameOver:e}){const[n,a]=g.useState(null),[s,r]=g.useState(!1);return g.useEffect(()=>{var p;if(s)return;const i=cn(t),o=Object.values(i).filter(h=>h>0).length,l=t.launchSites.length===0,c=t.timestamp,u=t.states.filter(h=>i[h.id]>0&&Object.entries(h.strategies).filter(([v,b])=>i[v]>0&&b===y.HOSTILE).length>0),d=t.launchSites.some(h=>h.lastLaunchTimestamp&&c-h.lastLaunchTimestamp<ae),m=ae-c;if(!u.length&&!d&&m>0&&m<=10&&(n?M(`Game will end in ${Math.ceil(m)} seconds if no action is taken!`,n,n+10,"gameOverCountdown",void 0,!1,!0):a(c)),o<=1||l||!u.length&&!d&&c>ae){const h=o===1?(p=t.states.find(v=>i[v.id]>0))==null?void 0:p.id:void 0;r(!0),M(["Game Over!","Results will be shown shortly..."],c,c+5,"gameOverCountdown",void 0,!1,!0),setTimeout(()=>{e({populations:i,winner:h,stateNames:Object.fromEntries(t.states.map(v=>[v.id,v.name])),playerStateId:t.states.find(v=>v.isPlayerControlled).id})},5e3)}},[t,e,n,s]),null}const uo="/assets/player-lost-background-D2A_VJ6-.png",lo="/assets/player-won-background-CkXgF24i.png",ot="/assets/draw-background-EwLQ9g28.png",co=E.div`
  height: 100vh;
  width: 100%;
  display: flex;
  justify-content: center;
...
`,gn="ALLIANCEPROPOSAL";function Eo(t,e,n,a=!1){const s=`${gn}_${t.id}_${e.id}`,r=a?`${t.name} has become friendly towards you. Do you want to form an alliance?`:`${t.name} proposes an alliance with ${e.name}. Do you accept?`,i=n.timestamp,o=i+10;M(r,i,o,s,[{id:"accept",text:"Accept"},{id:"reject",text:"Reject"}],!0)}function xo({worldState:t,setWorldState:e}){return Se(n=>{if(n.messageId.startsWith(gn)){const[,a,s]=n.messageId.split("_"),r=t.states.find(o=>o.id===a),i=t.states.find(o=>o.id===s);if(!r||!(i!=null&&i.isPlayerControlled))return;if(n.actionId==="accept"){const o=t.states.map(l=>l.id===a||l.id===s?{...l,strategies:{...l.strategies,[a]:y.FRIENDLY,[s]:y.FRIENDLY}}:l);e({...t,states:o}),M(`Alliance formed between ${r.name} and ${i.name}!`,t.timestamp,t.timestamp+5)}else n.actionId==="reject"&&M(`${i.name} has rejected the alliance proposal from ${r.name}.`,t.timestamp,t.timestamp+5)}}),null}function Fo({worldState:t}){const e=t.states.find(p=>p.isPlayerControlled),[n,a]=g.useState(!1),[s,r]=g.useState({}),[i,o]=g.useState([]),[l,c]=g.useState([]),[u,d]=g.useState(!1),m=Math.round(t.timestamp*10)/10;return g.useEffect(()=>{!n&&t.timestamp>0&&(a(!0),M("The game has started!",t.timestamp,t.timestamp+3))},[m]),g.useEffect(()=>{var p,h,v,b;if(e){const D=Object.fromEntries(t.states.map(x=>[x.id,x.strategies]));for(const x of t.states)for(const F of t.states.filter(B=>B.id!==x.id))e&&F.id===e.id&&x.strategies[F.id]===y.FRIENDLY&&F.strategies[x.id]!==y.FRIENDLY&&((p=s[x.id])==null?void 0:p[F.id])!==y.FRIENDLY&&Eo(x,e,t,!0),F.strategies[x.id]===y.FRIENDLY&&x.strategies[F.id]===y.FRIENDLY&&(((h=s[F.id])==null?void 0:h[x.id])!==y.FRIENDLY||((v=s[x.id])==null?void 0:v[F.id])!==y.FRIENDLY)&&M(`${F.name} has formed alliance with ${x.isPlayerControlled?"you":x.name}!`,m,m+3),x.strategies[F.id]===y.HOSTILE&&((b=s[x.id])==null?void 0:b[F.id])!==y.HOSTILE&&M(F.isPlayerControlled?`${x.name} has declared war on You!`:`${x.isPlayerControlled?"You have":x.name} declared war on ${F.name}!`,m,m+3,void 0,void 0,void 0,x.isPlayerControlled||F.isPlayerControlled);r(D)}},[m]),g.useEffect(()=>{e&&t.cities.filter(p=>p.stateId===e.id).forEach(p=>{const h=i.find(x=>x.id===p.id);if(!h)return;const v=p.population||0,b=h.population,D=Math.floor(b-v);D>0&&M(v===0?`Your city ${p.name} has been destroyed!`:[`Your city ${p.name} has been hit!`,`${D} casualties reported.`],m,m+3,void 0,void 0,!1,!0)}),o(t.cities.map(p=>({...p})))},[m]),g.useEffect(()=>{if(e){const p=t.launchSites.filter(h=>h.stateId===e.id);l.length>0&&l.filter(v=>!p.some(b=>b.id===v.id)).forEach(()=>{M("One of your launch sites has been destroyed!",m,m+3,void 0,void 0,!1,!0)}),c(p)}},[m]),g.useEffect(()=>{if(e&&!u){const p=t.cities.filter(b=>b.stateId===e.id),h=t.launchSites.filter(b=>b.stateId===e.id);!p.some(b=>b.population>0)&&h.length===0&&(M(["You have been defeated.","All your cities are destroyed.","You have no remaining launch sites."],m,m+5,void 0,void 0,!1,!0),d(!0))}},[m]),null}function Co({worldState:t}){const[e,n]=g.useState([]);pn(i=>{n(o=>i.messageId&&o.find(l=>l.messageId===i.messageId)?[...o.map(l=>l.messageId===i.messageId?i:l)]:[i,...o])}),Se(i=>{n(o=>o.filter(l=>l.messageId!==i.messageId))});const a=i=>Array.isArray(i)?i.map((o,l)=>f.jsx("div",{children:o},l)):i,s=(i,o)=>{const u=o-i;return u>60?0:u>50?1-(u-50)/10:1},r=g.useMemo(()=>{const i=t.timestamp,o=60;return e.filter(l=>{const c=l.startTimestamp||0;return i-c<=o}).map(l=>({...l,opacity:s(l.startTimestamp||0,i)}))},[e,t.timestamp]);return f.jsx(Ao,{children:r.map((i,o)=>f.jsxs(Do,{style:{opacity:i.opacity},children:[f.jsx("div",{children:a(i.message)}),i.prompt&&i.actions&&f.jsx(ko,{children:i.actions.map((l,c)=>f.jsx(So,{onClick:()=>hn(i.messageId,l.id),children:l.text},c))})]},o))})}const Ao=E.div`
  position: fixed;
  right: 0;
  max-height: 100%;
  bottom: 0;
...
`;function _o({updateWorldTime:t,currentWorldTime:e}){const[n,a]=g.useState(!1),s=g.useRef(null);Qt(i=>{if(!s.current){s.current=i;return}const o=i-s.current;s.current=i,!(o<=0)&&n&&t(o/1e3)},!0);const r=i=>{const o=Math.floor(i/86400),l=Math.floor(i%86400/3600),c=Math.floor(i%3600/60),u=Math.floor(i%60);return[[o,"d"],[l,"h"],[c,"m"],[u,"s"]].filter(([d])=>!!d).map(([d,m])=>String(d)+m).join(" ")};return f.jsx(Bo,{children:f.jsxs(To,{children:[f.jsxs(Io,{children:[e>0?"Current Time: ":"Game not started yet",r(e)]}),f.jsx(X,{onClick:()=>t(1),children:"+1s"}),f.jsx(X,{onClick:()=>t(10),children:"+10s"}),f.jsx(X,{onClick:()=>t(60),children:"+1m"}),f.jsx(X,{onClick:()=>a(!n),children:n?"Stop":"Start"})]})})}const Bo=E.div`
  position: absolute;
  left: 50%;
...
`,Io=E.div`
  ...
  font-weight: bold;
  margin-right: 15px;
`,wo=({setGameState:t})=>{const{state:{stateName:e}}=lt(),{worldState:n,setWorldState:a,updateWorldState:s}=or(e);return f.jsxs(f.Fragment,{children:[f.jsx(io,{worldState:n,setWorldState:a}),f.jsx(_o,{updateWorldTime:r=>s(n,r),currentWorldTime:n.timestamp??0}),f.jsx(mn,{worldState:n,setWorldState:a}),f.jsx(fo,{worldState:n}),f.jsx(Co,{worldState:n}),f.jsx(oo,{worldState:n,onGameOver:r=>t(ve,{result:r})}),f.jsx(Fo,{worldState:n}),f.jsx(xo,{worldState:n,setWorldState:a})]})},K={Component:wo,path:"playing"},Mo="/assets/play-background-BASXrsIB.png",jo=E.div`
  height: 100vh;
  width: 100%;
  display: flex;
  justify-content: center;
...
`,zo=E.img`
  ...
  height: auto;
  image-rendering: pixelated;
`,Uo=({setGameState:t})=>{const[e,n]=g.useState(!0);return g.useEffect(()=>{const a=setTimeout(()=>{n(!1)},5e3);return()=>clearTimeout(a)},[]),f.jsxs(No,{children:[f.jsx(Yo,{isFlashing:e}),!e&&f.jsxs(Go,{children:[f.jsx(zo,{src:Po,alt:"Nukes game"}),f.jsx("button",{onClick:()=>t(ye),children:"Play"})]})]})},ut={Component:Uo,path:""},Ho=Fn`
:root {
...
`,Xo=[{path:ut.path,element:f.jsx(V,{state:ut})},{path:ye.path,element:f.jsx(V,{state:ye})},{path:K.path,element:f.jsx(V,{state:K})},{path:ve.path,element:f.jsx(V,{state:ve})}];function Wo(){var n;const[t]=En(),e=t.get("path")??"";return f.jsx(f.Fragment,{children:(n=Xo.find(a=>a.path===e))==null?void 0:n.element})}function V({state:t}){const e=xn();return f.jsxs(f.Fragment,{children:[f.jsx(Ho,{}),f.jsx(t.Component,{setGameState:(n,a)=>e({search:"path="+n.path},{state:a})})]})}export{Wo as NukesApp,Xo as routes};
