...
`,Ar=E.div`
  ...
  pointer-events: none;
`;function Dr({launchSite:t,worldTimestamp:e,isPlayerControlled:n}){const[a,s]=fr(t),[r,i]=xe(),o=t.lastLaunchTimestamp&&t.lastLaunchTimestamp+ce>e,l=o?(e-t.lastLaunchTimestamp)/ce:0;return d.jsx(kr,{onMouseEnter:()=>r(t),onMouseLeave:()=>i(t),onClick:()=>n&&s(),style:{"--x":t.position.x,"--y":t.position.y,"--cooldown-progress":l},"data-selected":a,"data-cooldown":o})}const kr=E.div`
  transform: translate(calc(var(--x) * 1px), calc(var(--y) * 1px)) translate(-50%, -50%);
  position: absolute;
  width: 5px;
  height: 10px;
...
`,Do=({setGameState:t})=>{const{state:{stateName:e}}=ut(),{worldState:n,setWorldState:a,updateWorldState:s}=ir(e);return d.jsxs(d.Fragment,{children:[d.jsx(ao,{worldState:n,updateWorldState:s,setWorldState:a}),d.jsx(lo,{worldState:n}),d.jsx(Eo,{}),d.jsx(so,{worldState:n,onGameOver:r=>t(pe,{result:r})}),d.jsx(bo,{worldState:n}),d.jsx(yo,{worldState:n,setWorldState:a})]})},W={Component:Do,path:"playing"},ko="/assets/play-background-BASXrsIB.png",_o=E.div`
  height: 100vh;
  width: 100%;
  display: flex;
  justify-content: center;
...
`,Lo=E.img`
  ...
  height: auto;
  image-rendering: pixelated;
`,Po=({setGameState:t})=>{const[e,n]=v.useState(!0);return v.useEffect(()=>{const a=setTimeout(()=>{n(!1)},5e3);return()=>clearTimeout(a)},[]),d.jsxs(Mo,{children:[d.jsx(jo,{isFlashing:e}),!e&&d.jsxs(Oo,{children:[d.jsx(Lo,{src:To,alt:"Nukes game"}),d.jsx("button",{onClick:()=>t(ge),children:"Play"})]})]})},ot={Component:Po,path:""},Ro=bn`
:root {
...
`,$o=[{path:ot.path,element:d.jsx(X,{state:ot})},{path:ge.path,element:d.jsx(X,{state:ge})},{path:W.path,element:d.jsx(X,{state:W})},{path:pe.path,element:d.jsx(X,{state:pe})}];function Ho(){var n;const[t]=En(),e=t.get("path")??"";return d.jsx(d.Fragment,{children:(n=$o.find(a=>a.path===e))==null?void 0:n.element})}function X({state:t}){const e=xn();return d.jsxs(d.Fragment,{children:[d.jsx(Ro,{}),d.jsx(t.Component,{setGameState:(n,a)=>e({search:"path="+n.path},{state:a})})]})}export{Ho as NukesApp,$o as routes};
