...
| Game creation   | ✅ Live — spec → moderated submission → round dispatched to an agent backend → delivery over the build channel (`submit_sources`) → gate run → publish. Not a merged PR; see [`architecture.md`](./architecture.md)                                                 |
