...
- ✅ **Done (2026-07-26): the first 60 seconds work for allowed visitors.** Land on the site → sign in (allowlist) → play a good game. Anonymous visitors still get the closed-beta splash; catalog, published games and play telemetry stay behind the session wall. Visit telemetry remains open so the splash funnel is measurable. Opening play to strangers without sign-in is Stage 2 — not the closed beta.
