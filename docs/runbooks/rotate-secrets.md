...
| `resend-api-key`          | `npm run beta:invite -w @gamedevpl/api -- you@example.com --dry-run`, or `npm run beta:welcome -w @gamedevpl/api -- --only you@example.com`, then a real send to yourself                                                                                                                                 |
