...
export function getSystemPrompt() {
  ...
  You will be using the \`updateFile\`, \`createFile\`, \`deleteFile\` and \`explanation\` functions in response.
  ...
  Parse my application source code and make changes using the \`updateFile\`, \`createFile\`, \`deleteFile\` and \`explanation\` functions, do not output text, use function calling.
  `;
