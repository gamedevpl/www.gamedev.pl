...
export const AI_DIPLOMACY_HOSTILITY_DISTANCE_THRESHOLD = 500; // Maximum distance between tribe centers for hostility to be considered (prevents aggression towards distant tribes)
export const AI_DIPLOMACY_MIN_TRIBE_SIZE_FOR_HOSTILITY = 6; // Minimum adult tribe members required before considering hostility (prevents small struggling tribes from attacking)
