...
/** Radius within which family members must gather (in pixels) */
export const TRIBE_SPLIT_GATHER_RADIUS = 50;
/** Maximum time to wait for family to gather (in game hours) */
export const TRIBE_SPLIT_GATHER_TIMEOUT_HOURS = 48;
/** Minimum distance from current territory for migration (in pixels) */
export const TRIBE_SPLIT_MIGRATION_MIN_DISTANCE = 300;
/** Radius to search for storage buildings for concentration strategy (in pixels) */
export const TRIBE_SPLIT_CONCENTRATION_STORAGE_RADIUS = 100;
/** Maximum time for any phase before resetting (in game hours) */
export const TRIBE_SPLIT_PHASE_TIMEOUT_HOURS = 72;
/** Cooldown after a failed split attempt (in game hours) - 1 week */
export const TRIBE_SPLIT_COOLDOWN_AFTER_FAILURE_HOURS = 168;
