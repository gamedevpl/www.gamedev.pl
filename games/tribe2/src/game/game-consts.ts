...
export const HEIGHT_SCALE = 120; // Height scale for terrain displacement (matches WebGPU default)
...
// Biome Constants
export const TREE_RADIUS = 8; // pixels
export const TREE_SPAWN_THRESHOLD = 0.48; // Minimum heightmap value for trees to spawn
export const TREE_SPAWN_DENSITY = 0.15; // Chance of a tree spawning in a valid location
