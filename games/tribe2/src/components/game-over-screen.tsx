...
export const GameOverScreen: React.FC = () => {
  ...
  return (
    <GameOverContainer>
      ...
      {gameOverDetails && gameOverDetails.generations !== undefined && (
        <>
          <InfoText>Generations Survived: {gameOverDetails.generations}</InfoText>
          <InfoText>Cause of Extinction: {gameOverDetails.cause || 'Unknown'}</InfoText>
        </>
      )}
      {(!gameOverDetails || gameOverDetails.generations === undefined) && <InfoText>Game details are unavailable.</InfoText>}
