...
import { LION_EATING_STATE } from './lion-eating-state';

// Re-export all states
export { LION_IDLE_STATE, LION_MOVING_TO_TARGET_STATE, LION_CHASING_STATE, LION_AMBUSH_STATE, LION_EATING_STATE };

// Export lion state types
export type LionStateType = 'LION_IDLE' | 'LION_MOVING_TO_TARGET' | 'LION_CHASING' | 'LION_AMBUSH' | 'LION_EATING';

// Export combined array of all lion states
export const LION_STATES = [LION_IDLE_STATE, LION_MOVING_TO_TARGET_STATE, LION_CHASING_STATE, LION_AMBUSH_STATE, LION_EATING_STATE];
