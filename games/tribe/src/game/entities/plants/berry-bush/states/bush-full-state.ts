...
import { HOURS_PER_GAME_DAY, GAME_DAY_IN_REAL_SECONDS, BERRY_BUSH_SPREAD_COOLDOWN_HOURS } from "../../../../world-consts";
...
export const bushFullState: State<BerryBushEntity, BushFullStateData> = {
  ...
  update: (data: BushFullStateData, context: StateContext<BerryBushEntity>): StateTransition => {
    ...
    if (entity.age >= entity.lifespan) {
      return { nextState: BUSH_DYING, data: { ...data, enteredAt: updateContext.gameState.time, previousState: BUSH_FULL } };
    }
