...
export const units: Unit[] = [
  ...
  { id: 701, col: -8, row: 0, sizeCol: 8, sizeRow: 2, type: 'warrior', command: 'defend' },
  { id: 702, col: 8, row: 0, sizeCol: 8, sizeRow: 2, type: 'warrior', command: 'defend' },
  
  // Hidden strong units (reduced from 4 to 3 tanks)
  { id: 703, col: -8, row: -4, sizeCol: 4, sizeRow: 4, type: 'tank', command: 'wait-charge' },
  { id: 704, col: 0, row: -4, sizeCol: 4, sizeRow: 4, type: 'tank', command: 'wait-charge' },
  { id: 705, col: 8, row: -4, sizeCol: 4, sizeRow: 4, type: 'tank', command: 'wait-charge' },
  
  // Hidden artillery support (kept 2 units)
  { id: 706, col: -12, row: -8, sizeCol: 6, sizeRow: 2, type: 'artillery', command: 'wait-bombard' },
  { id: 707, col: 12, row: -8, sizeCol: 6, sizeRow: 2, type: 'artillery', command: 'wait-bombard' },
  
  // Hidden archer support (reduced from 4 to 3 units)
  { id: 708, col: -16, row: -6, sizeCol: 4, sizeRow: 2, type: 'archer', command: 'wait-fire' },
  { id: 709, col: 0, row: -6, sizeCol: 4, sizeRow: 2, type: 'archer', command: 'wait-fire' },
  { id: 710, col: 16, row: -6, sizeCol: 4, sizeRow: 2, type: 'archer', command: 'wait-fire' },
];
