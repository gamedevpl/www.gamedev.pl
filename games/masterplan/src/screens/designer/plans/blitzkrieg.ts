...
export const units: Unit[] = [
  ...
  { id: 501, col: -4, row: 2, sizeCol: 4, sizeRow: 4, type: 'tank', command: 'advance' },
  { id: 502, col: 4, row: 2, sizeCol: 4, sizeRow: 4, type: 'tank', command: 'advance' },
  { id: 503, col: 0, row: 0, sizeCol: 4, sizeRow: 4, type: 'tank', command: 'advance' },

  // Fast-moving warrior support (reduced from 3 to 2 units)
  { id: 504, col: -10, row: -2, sizeCol: 6, sizeRow: 2, type: 'warrior', command: 'advance' },
  { id: 505, col: 10, row: -2, sizeCol: 6, sizeRow: 2, type: 'warrior', command: 'advance' },

  // Mobile artillery (reduced from 2 to 1 unit)
  { id: 506, col: 0, row: -6, sizeCol: 8, sizeRow: 2, type: 'artillery', command: 'advance' },

  // Fast-moving archer support (kept 2 units)
  { id: 507, col: -16, row: -8, sizeCol: 4, sizeRow: 2, type: 'archer', command: 'advance' },
  { id: 508, col: 16, row: -8, sizeCol: 4, sizeRow: 2, type: 'archer', command: 'advance' },
];
