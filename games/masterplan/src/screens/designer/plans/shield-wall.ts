...
export const units: Unit[] = [
  ...
  { id: 401, col: -16, row: 0, sizeCol: 8, sizeRow: 2, type: 'warrior', command: 'defend' },
  { id: 402, col: 0, row: 0, sizeCol: 8, sizeRow: 2, type: 'warrior', command: 'defend' },
  { id: 403, col: 16, row: 0, sizeCol: 8, sizeRow: 2, type: 'warrior', command: 'defend' },

  // Second line of archers for ranged support (reduced from 4 to 3 units)
  { id: 404, col: -12, row: -4, sizeCol: 4, sizeRow: 2, type: 'archer', command: 'fire-at-will' },
  { id: 405, col: 0, row: -4, sizeCol: 4, sizeRow: 2, type: 'archer', command: 'fire-at-will' },
  { id: 406, col: 12, row: -4, sizeCol: 4, sizeRow: 2, type: 'archer', command: 'fire-at-will' },

  // Artillery at the back for long-range support (reduced from 2 to 1 unit)
  { id: 407, col: 0, row: -8, sizeCol: 8, sizeRow: 2, type: 'artillery', command: 'bombard' },

  // Tanks as mobile reserves (kept 2 units)
  { id: 408, col: -16, row: -6, sizeCol: 4, sizeRow: 4, type: 'tank', command: 'guard' },
  { id: 409, col: 16, row: -6, sizeCol: 4, sizeRow: 4, type: 'tank', command: 'guard' },
];
